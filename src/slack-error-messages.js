...
const errorMessages = {
  ...
  "error_name_taken_i18n": "Unfortunately, the international emoji set already includes an emoji named <b>{newEmojiName}</b>. Mind trying a different name?",
  "error_name_taken": "The name <b>{newEmojiName}</b> is already in use by another emoji.",
